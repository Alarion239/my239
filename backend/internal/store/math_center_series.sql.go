...
VALUES ($1, $2, $3, $4)
RETURNING id, math_center_id, number, name, due_at, pdf_object_key, published_at, created_at
`
...
SELECT id, math_center_id, number, name, due_at, pdf_object_key, published_at, created_at
FROM math_center_series
WHERE id = $1
`
